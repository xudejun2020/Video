    ...
    <div class="main_content">
        <div class="main_content_inner">
            ...
            <nav class="responsive-tab">
                <ul>
                    <li class="uk-active"><a href="#"> <i class="uil-video"></i> Videos </a></li>
                    <li><a href="#"> <i class="uil-game"></i> Games</a></li>
                    <li><a href="#"> <i class="uil-film"></i> Movies </a></li>
                </ul>
            </nav>
            ...
            <div class="section-small">
                <div class="uk-child-width-1-4@m uk-child-width-1-3@s " uk-grid>
                    ...
                    <div>
                        ...
                        <a href="#">
                            <div class="catagroy-card" data-src="assets/images/channals/img-5.jpg" uk-img>
                    ...
                    <div>
                        <a href="#">
                            <div class="catagroy-card" data-src="assets/images/channals/img-4.jpg" uk-img>
                                <div class="catagroy-card-content">
                                    <h4> Sports </h4>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="#">
                            <div class="catagroy-card" data-src="assets/images/channals/img-2.jpg" uk-img>
                                <div class="catagroy-card-content">
                                    <h4> Workout </h4>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <a href="#">
                            <div class="catagroy-card" data-src="assets/images/channals/img-3.jpg" uk-img>
                                <div class="catagroy-card-content">
                                    <h4> Music </h4>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <a href="#">
                            <div class="catagroy-card" data-src="assets/images/channals/img-1.jpg" uk-img>
                                <div class="catagroy-card-content">
                                    <h4> BattleState </h4>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <a href="#">
                            <div class="catagroy-card" data-src="assets/images/channals/img-6.jpg" uk-img>
                                <div class="catagroy-card-content">
                                    <h4> Animals </h4>
                                </div>
                            </div>
